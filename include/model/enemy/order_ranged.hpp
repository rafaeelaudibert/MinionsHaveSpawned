...
class OrderRanged : public Enemy
{
public:
    OrderRanged(std::string name,
                ...
                float angle = 0,
                glm::vec3 scale = glm::vec3(1.5f, 1.5f, 1.5f)) : Enemy(name, color, Route::MID, position, orientation, angle, scale)
    {
        this->build();
        ...
        this->max_life_points = this->current_life_points = 30;
    };
