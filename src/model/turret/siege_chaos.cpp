...
void SiegeChaos::build()
{
    // Initialize object, shaders, and textures
    ResourceManager::load_object("../../src/objects/siege_chaos_turret.obj", this, this->name);
    ...
    case TurretColor::RED:
        this->texture = ResourceManager::load_texture("../../src/textures/siege_chaos_turret_red.jpg", this->name);
        break;
    case TurretColor::BLUE:
        this->texture = ResourceManager::load_texture("../../src/textures/siege_chaos_turret_blue.jpg", this->name);
        break;
    default:
...
void SiegeChaos::render(glm::mat4 view, glm::mat4 projection)
{
...
void SiegeChaos::update(float delta_time){
