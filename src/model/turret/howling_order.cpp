...
void HowlingOrder::build()
{
    // Initialize object, shaders, and textures
    ResourceManager::load_object("../../src/objects/ha_order_turret.obj", this, this->name);
    ...
    case TurretColor::RED:
        this->texture = ResourceManager::load_texture("../../src/textures/ha_order_turret_red.jpg", this->name);
        break;
    case TurretColor::BLUE:
        this->texture = ResourceManager::load_texture("../../src/textures/ha_order_turret_blue.jpg", this->name);
        break;
    default:
...
void HowlingOrder::render(glm::mat4 view, glm::mat4 projection)
{
        ...
        if (this->ellapsed_time >= this->recharge_time)
        {
            ...
            if (this->target != nullptr) {  // Can start to shoot in that target
                ...
                this->ammo = new EnergyBall(this->name + "_energy_ball",
                                            this->target, 3.5f, 10.0f,
                                            AmmoEffects::FreezingEffect(),
