...
void ChaosMelee::build()
{
    // Initialize object, shaders, and textures
    ResourceManager::load_object("../../src/objects/chaos_minion_melee.obj", this, this->name);
    ...
    {
    case EnemyColor::RED:
        this->texture = ResourceManager::load_texture("../../src/textures/chaos_minion_melee_red.jpg", this->name);
        break;
    case EnemyColor::BLUE:
        this->texture = ResourceManager::load_texture("../../src/textures/chaos_minion_melee_blue.jpg", this->name);
        break;
    default:
        throw std::runtime_error("[ERROR] Error when trying to load the ChaosMelee model - Non existent EnemyColor.");
    }

    return;
}

void ChaosMelee::render(glm::mat4 view, glm::mat4 projection)
{
