...
void ChaosRanged::build()
{
    // Initialize object, shaders, and textures
    ResourceManager::load_object("../../src/objects/chaos_minion_ranged.obj", this, this->name);
    ...
    {
    case EnemyColor::RED:
        this->texture = ResourceManager::load_texture("../../src/textures/chaos_minion_ranged_red.jpg", this->name);
        break;
    case EnemyColor::BLUE:
        this->texture = ResourceManager::load_texture("../../src/textures/chaos_minion_ranged_blue.jpg", this->name);
        break;
    default:
        throw std::runtime_error("[ERROR] Error when trying to load the ChaosRanged model - Non existent EnemyColor.");
    }

    return;
}

void ChaosRanged::render(glm::mat4 view, glm::mat4 projection)
{
